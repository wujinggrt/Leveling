...
namespace GUILeveling
{
    public partial class UpdateForm : Form
    {
        ...
        // 窗口出现位置
        public UpdateForm(System.Windows.Forms.Form ParentForm)
            : this()
        {
        ...
        private void updateBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                //改变正在输入的测站数    
                storageStatusLabel.Text = "第" + stationNO + "站：修改成功";
            }
            else
            {
                storageStatusLabel.Text = "修改失败";
        ...
        private void StationNOBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                stationCountLabel.Text = "第" + stationNOBox.Text + "站！";
                return;
            }
        }
